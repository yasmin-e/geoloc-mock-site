      ...
      <div className="demo-content">
        ...
        <div className="content-step">
          ...
          <div className="content-info">
            ...
            <p className="content-text">
              The recipient receives a tracking link
              that allows to precisely find its location
            </p>
          </div>
        </div>
        <div className="content-step">
          ...
          <div className="content-info">
            ...
            <p className="content-text">
              You receive the exact location of the desired phone
              displayed on a map and can track its movements
            </p>
          </div>
        </div>
      </div>
